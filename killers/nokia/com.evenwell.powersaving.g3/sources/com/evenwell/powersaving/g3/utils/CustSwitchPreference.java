...
public class CustSwitchPreference extends SwitchPreference {
    private static String TAG = TAG.PSLOG;
    private Context mContext;

    public CustSwitchPreference(Context context) {
        super(context);
        this.mContext = context;
    }

    public CustSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public CustSwitchPreference(Context context, AttributeSet attrs, int defStyle) {
