...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C02321();
    ...
    static class C02321 implements Creator<PlaybackStateCompat> {
        C02321() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C02331();
        ...
        static class C02331 implements Creator<CustomAction> {
            C02331() {
            }
