...
<溴>>
1.当应用程序在后台打开时，在主屏幕中向上滑动，然后<strong>向下滑动应用程序图标</strong>。<strong>down</strong>.
<<br>>
2.点击锁定图标。
<<br>>
3.完成-现在应用程序已锁定在任务栏中。

<<div class="img-block">class="img-block">
<图><figure>
<img src="/assets/img/vivo/vivo_1.jpg"><img src="/assets/img/vivo/vivo_1.jpg">
<figcaption>1.在后台打开应用程序时，向上向下滑动<br>。</figcaption><figcaption>1. Swipe up the app down <br> while it is open in the background.</figcaption>
</figure></figure>

<图><figure>
<img src="/assets/img/vivo/vivo_2.jpg"><img src="/assets/img/vivo/vivo_2.jpg">
<figcaption>2.轻敲显示的锁定图标。</figcaption><figcaption>2. Tap on the lock icon that appears.</figcaption>
  </figure>
