...
UPDATE: We record an significantly increased number of app killing on Samsung's Android Pie flavor. The hints snow on adaptive battery being much more eager than in stock Android. We strongly suggest to turn off any adaptive battery and putting apps to sleep options as of below.
</div>
