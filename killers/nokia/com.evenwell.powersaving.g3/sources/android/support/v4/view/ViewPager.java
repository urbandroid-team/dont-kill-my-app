...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02601();
    ...
    private static final Interpolator sInterpolator = new C02612();
    ...
    private final Runnable mEndScrollRunnable = new C02623();
    ...
    static class C02601 implements Comparator<ItemInfo> {
        C02601() {
        }
    ...
    static class C02612 implements Interpolator {
        C02612() {
        }
    ...
    class C02634 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02641());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C02641 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02641() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02634());
    }
        ...
        switch (ev.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(FileOperator.MAX_DIR_LENGTH, (float) this.mMaximumVelocity);
